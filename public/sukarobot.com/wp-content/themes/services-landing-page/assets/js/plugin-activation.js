jQuery(document).ready(function($) {
    'use strict';
    var this_obj = services_landing_page_plugin_activate_plugin;
    ...
    $(document).on('click', '.services-landing-page-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message services-landing-page-plugin-install');
                button.addClass('button-primary services-landing-page-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.services-landing-page-recommended-plugins .services-landing-page-activation-note').css('display','block');
    ...
    $(document).on('click', '.services-landing-page-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .services-landing-page-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .services-landing-page-recommended-plugins').css('display','none');
    });
