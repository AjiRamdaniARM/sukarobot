...
<div class="wrapper">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse pull-right" id="navbar-collapse">
          <ul class="nav navbar-nav">
            <li><a href="<?= base_url('index.php/home') ?>"><i class="fa fa-key"></i> Admin</a></li>
          </ul>
        </div>
        <!-- /.navbar-collapse -->
      </div>
      ...
      <section class="content">
        ...
        <div class="box box-default">
          <div class="box-header with-border">  
            ...
            <form action="<?= base_url('index.php/welcome/insert') ?>" method="POST" enctype="multipart/form-data">
              <input type="hidden" name="<?= $this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
                ...
                <div class="box-footer">
                    <small><font color="red">NB : Pastikan semua data yang dimasukkan sudah benar sebelum menekan tombol daftar!</font></small>
  ...
  <footer class="main-footer">
    <div class="container">
        ...
        <strong>Copyright &copy; <?= date('Y') ?> <a href="https:sukarobot.com" target="blank">Sukarobot Academy</a>.</strong> All rights reserved.
