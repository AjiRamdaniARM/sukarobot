            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- Horizontal Form -->
                        <form action="{{ url('/pelatihan/post') }}" method="POST" class="row g-3"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="judul" id="floatingName"
                                        placeholder="Judul Pelatihan" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="harga" id="Harga"
                                        placeholder="Harga Pelatihan" required>
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="deskripsi" id="floatingName1"
                                ...
                                <tbody>
                                    @foreach ($pelatihan as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('/pelatihan/edit', $item->id) }}" style="button"
                                                    class="btn btn-warning">Edit</a>
                                                <a href="{{ url('/pelatihan/delete', $item->id) }}" style="button"
